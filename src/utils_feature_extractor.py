...
# @Last Modified time: 2018-08-13 17:10:26
...
"""
Use the audio sinosoid to calculate all voice-related features, such as MFCC, Filterbank, Energy, etc.
Disable the visualization module to warm start
"""
